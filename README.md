...
- 预配置了部分插件（包括但不限于 DNS 套娃，<b>(注意，使用dnsfilter作为广告过滤手段，使用dnsproxy作为dns分流措施)</b>
- 可无脑 opkg kmod
- R2C/R2S核心频率1.6，R4S核心频率2.2/1.8（建议使用5v4a电源，死机大多数情况下，都是因为<b>你用的电源过于垃圾</b>，另外，你也可以选择使用<b>自带的app限制最大频率</b>，茄子🍆）
- O3 编译，CFLAG优化
